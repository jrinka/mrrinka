...
const taskInstructions = {
  ...
  "global-issue": "Evaluate the student's proposed global issue for focus, wider significance, transnational relevance and local manifestation, and grounding in BOTH selections and their wider works/bodies of work. A theme alone is insufficient. For language-literature, the IO uses literary and non-literary material; for literature, an originally English work and a work in translation. Ask for missing eligibility information; do not assume it. Do not suggest or reformulate an issue, select extracts, construct an oral outline or script, or require comparison as an IO criterion.",
