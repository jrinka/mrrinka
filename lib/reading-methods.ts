...
export const readingMethods = {
  ...
  soapstone: {
    ...
    steps:[
      ...
      {letter:"P",title:"Purpose",prompt:"What does the speaker invite that audience to think, feel or do? Distinguish this from the subject.",example:"The speech honors the dead while redirecting the living toward continuing their work. It moves beyond commemorating a battle to renewing a political commitment."},
