...
export const readingMethods = {
  tpcastt: {
    title: "TPCASTT", subtitle: "A poetry reading scaffold", work: "Mirror — Sylvia Plath",
    ...
    steps: [
      {letter:"T",title:"Title: a first hypothesis",prompt:"Before reading, what possibilities does the title suggest? Keep the prediction provisional.",example:"A mirror might promise an accurate reflection—or raise questions about how we see ourselves."},
      ...
      {letter:"A",title:"Attitude",prompt:"Describe the speaker’s attitude with evidence. Do not automatically equate the speaker with the poet.",example:"The voice initially sounds assured and clinical. The woman’s distress unsettles the apparent neutrality of its account."},
      {letter:"S",title:"Shifts",prompt:"Locate a change in voice, tone, imagery, time or argument. What becomes possible after it?",example:"“Now I am a lake” begins the second stanza. Looking becomes searching; the final “terrible fish” makes ageing threatening."},
      ...
      {letter:"T",title:"Theme",prompt:"Write a defensible claim about meaning, not a one-word topic. Test it against the whole poem.",example:"One reading: looking for certainty in a reflection can intensify anxiety about change. Test it against the speaker’s confident opening."},
  ...
  soapstone: {
    title:"SOAPSTone", subtitle:"A rhetorical reading scaffold", work:"Gettysburg Address — Abraham Lincoln",
    ...
    steps:[
      {letter:"S",title:"Speaker",prompt:"Who speaks, in what capacity, and how is authority established? Distinguish a speaker from a publisher.",example:"Lincoln speaks as US president, but repeatedly places himself within a collective ‘we’. His position gives authority; the pronoun shares responsibility."},
      ...
      {letter:"T",title:"Tone",prompt:"Name an attitude precisely, then find its textual basis. Trace changes rather than attaching one adjective to everything.",example:"The tone moves from solemn commemoration towards resolve. The sequence ‘we can not dedicate—we can not consecrate—we can not hallow’ limits the speakers’ power before the turn towards duty."},
    ] satisfies ReadingStep[],
