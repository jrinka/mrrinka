export const blogExample = {
  ...
  "credit": "Oliver Emberton, “If you want to follow your dreams, you have to say no to all the alternatives,” oliveremberton.com. Supplied exam version, cataloged as May 2024, TZ1, Text 1. Words and illustrations retain their original appearance. Rights remain with their holders. Only the blog regions are reproduced; the current online version includes additional material.",
  ...
  "views": [
    {
      ...
      "width": 1370,
      "height": 1430,
      "alt": "Blog masthead and title above an explanation of competing desires. Three colorful illustrations show bees in a beachball, bees aiming toward different companies, and a descending achievement graph."
    },
    {
      "label": "Page 2 · advice",
    ...
    },
    {
      ...
      "width": 1370,
      "height": 365,
      "alt": "Three bees in a green ball aim toward Facebook, Google and Amazon. The adjacent text argues that attempting all three would leave the reader nowhere."
    },
    {
      "label": "Graph & focus",
