...
export const speechExample: LiteraryReading = {
  ...
  "sources": [
    {
      "label": "Page 1",
      "url": "/examples/clark-hillary-page-1.png"
    },
    {
      "label": "Page 2",
  ...
  "passages": [
    {
      "title": "Everest and character",
      "paragraphs": [
        "On 29 May 1953 a young New Zealander stood on top of Mount Everest with his climbing companion Tenzing Norgay.",
    ...
    {
      "title": "Family and national mourning",
      "paragraphs": [
    ...
    {
      "title": "Extraordinary challenges and familiar details",
      "paragraphs": [
    ...
    {
      "title": "Service and what Hillary represented",
      "paragraphs": [
  ...
  "sections": {
    "read-the-tribute-as-a-whole": {
      "label": "Read the whole tribute",
      "phase": "Orient",
      "passage": null
    },
    "make-achievement-reveal-character": {
      "label": "Achievement & character",
      "phase": "Analyse",
      "passage": 0
    },
    "bring-private-loss-into-national-mourning": {
      "label": "Shared mourning",
      "phase": "Analyse",
      "passage": 1
    },
    "keep-the-hero-recognisably-human": {
      "label": "A familiar hero",
      "phase": "Analyse",
      "passage": 2
    },
    "make-service-the-lasting-achievement": {
      "label": "Service & values",
      "phase": "Analyse",
      "passage": 3
    },
    "give-the-audience-an-attainable-legacy": {
      "label": "An attainable legacy",
      "phase": "Analyse",
      "passage": 4
    },
  ...
  "fields": [
    {
      "key": "contrast",
      "label": "The tribute’s movement",
      "hint": "How does Clark connect achievement, shared loss and a continuing legacy?"
    },
    {
      "key": "evidence",
      "label": "Connected evidence",
      "hint": "Choose precise details that show how praise becomes relevant to listeners."
    },
    {
      "key": "analysis",
      "label": "Your analytical paragraph",
      "hint": "Develop one claim about language, audience and the purpose of this tribute."
    }
  ],
  "checks": [
    "Have I connected a precise choice with this funeral occasion?",
    "Have I explained who is included in collective language?",
    "Have I distinguished the source’s wording from imagined delivery?",
    "Have I shown how the detail contributes to the tribute as a whole?"
  ],
  "filename": "clark-hillary-speech-notes",
  "wholeLabel": "Whole speech"
};
