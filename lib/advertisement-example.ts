...
export const advertisementViews = [
  ...
  { id: "product", label: "04 · Bottle", title: "A recognizable choice", x: .836, y: .318, width: .111, height: .442,
    alt: "Close-up of the FIJI bottle, with a blue cap and a leafy, floral label, isolated against a light background.",
    prompt: "Compare this small, clearly labeled bottle with the large anonymous one. How do the plant imagery and surrounding space develop the product’s associations?",
