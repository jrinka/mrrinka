...
export const refineries: Record<RefineryKind, { title: string; description: string; evidence: string; draft: string }> = {
  ...
  "global-issue": { title: "Global Issue Refinery", description: "Test the focus of your issue and its connection to both texts.", evidence: "Identify both texts and their authors or creators, their course eligibility, and the details you chose that support your proposed issue.", draft: "Your proposed global issue and your explanation of its connection to each text" },
  "line-of-inquiry": { title: "Line of Inquiry Refinery", description: "Test the focus and analytical potential of your HLE question.", evidence: "Name your chosen work or body of work and its author or creator. Provide the textual details and authorial choices that prompted your inquiry.", draft: "Your proposed line of inquiry and why you want to explore it" },
};
