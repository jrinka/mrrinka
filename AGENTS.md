...
- Keep the graphite (#25282B), citron (#D8ED61), light-paper design unless asked otherwise.
- Use sans serif headings and monospace labels; prioritize readable lesson text.
- Public students do not sign in. Never weaken teacher authorization or enable a production bypass.
- Always pull and inspect the latest course JSON before editing. Preserve stable IDs and teacher changes.
- Use stylistic photography with no visible faces. Always display photographer credit and link to the original source wherever a photo appears.
