...
export default function TextTypeGuide({ body, itemId, href, showExample, exampleChoice }: { body: string; itemId: string; href: string; showExample: boolean; exampleChoice?: "wwf" | "cycling" }) {
  ...
  return <>
    ...
    {showExample && worked ? <>
      ...
      {kind === "cartoon" ? <CartoonGuide body={worked} href={href} /> : kind === "prose" || kind === "poetry" ? <LiteraryReadingGuide key={itemId} body={worked} href={href} example={kind === "poetry" ? poetryExample : proseExample} /> : kind === "infographic" ? (isAdditional ? <CyclingGuide body={worked} href={href} /> : <InfographicGuide body={worked} />) : kind === "advertisement" ? <AdvertisementGuide body={worked} href={href} /> : kind === "charity-appeal" ? (isAdditional ? <CharityAppealGuide body={worked} href={href} /> : <ElephantAppealGuide body={worked} href={href} />) : kind === "drama" ? <DramaGuide body={worked} href={href} /> : kind === "nonfiction" ? <NonfictionGuide body={worked} href={href} /> : <Markdown>{worked}</Markdown>}
    </> : <>
